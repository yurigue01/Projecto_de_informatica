        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-7 col-6">
                    <h4 class="page-title">Alteração Area</h4>
                </div>
                <form action="edit_area_adm.php" method="post" >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="c_Area" class="form-control" type="text" value="<?=$row['Area']?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input name="c_idArea" class="form-control" type="text" value="<?=$row['idArea']?>">
                                                            </div>
                                                        </div>
