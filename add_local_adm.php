  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            $link->close();
            ?>
            <form method="POST" action="ad_loca_adm.php" onSubmit="return validar()">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <label>Local</label>
                                        <input type="text" id="j_Local" name="j_Local"  class="form-control >
                                </div>
<button style="background-color: #229bc6; color: #fff" class="btn account-btn" type="submit">Submeter</button>
            ...
            <script src="assets/js/bootstrap.min.js">
                ...
                function validar() {
                    ...
                    if (Local=="") {
                        document.getElementById("Local").setCustomValidity("Preencha a Categoria de Produto!");
