...
if (!empty($_POST['Mensagem']) || !empty($_POST['Oferta_ID_oferta1']) || !empty($_POST['Utilizador_ID_utilizador']) ) {
    $nomecad = $_POST['Mensagem'];
    $Oferta_ID_oferta1= $_POST['Oferta_ID_oferta1'];
    $Utilizador_ID_utilizador = $_POST['Utilizador_ID_utilizador'];



    $sql = "INSERT INTO candidatura (Mensagem, Oferta_ID_oferta1, Utilizador_ID_utilizador  ) VALUES ('$nomecad', '$Oferta_ID_oferta1','$Utilizador_ID_utilizador')";
...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        $catc  = "SELECT * FROM candidatura INNER JOIN oferta ON  candidatura.Oferta_ID_oferta1= oferta.ID_oferta INNER JOIN utilizador ON candidatura.Utilizador_ID_utilizador= utilizador.ID_utilizador  ";
            ...
            <div class="profile-tabs">
                <ul class="nav nav-tabs nav-tabs-bottom">
                    <li class="nav-item"><a class="nav-link active" href="#about-cont" data-toggle="tab">Candidatura</a></li>
                              ...
                              <form action="teste_cand.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="card-box">
                                    ...
                                    <div class="experience-box">
                                        <textarea type="text" style="width: 55%;" name="Mensagem" cols="10" rows="3"></textarea>
                                    </div>
                                    </div>
