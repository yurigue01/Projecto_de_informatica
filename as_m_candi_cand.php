        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">As minhas candidatura</h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            $id_3=$_SESSION["ID_utilizador"];


                            $candida="SELECT candidatura.*, utilizador.* , oferta.*  FROM candidatura inner join utilizador on candidatura.Utilizador_ID_utilizador = utilizador.ID_utilizador inner join oferta on candidatura.Oferta_ID_oferta1 = oferta.ID_oferta  where ID_utilizador= '$id_3'";
                            if($resultado=$link->query($candida)){
