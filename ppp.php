        ...
        <ul class="nav user-menu float-right">
            <li class="nav-item dropdown has-arrow">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="change_password_ad.html">Alterar Password</a>
...
Gerir Utilizador</span></a>
                    ...
                    <li>
                        <a href="GerirOfert.html"> <span>Gerir Oferta</span></a>
                    </li>
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <td><a href="elimina-utilizador.php?id='.$row['ID_utilizador'].'" class="fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="edit-utilizador-formulario.php?id='.$row['ID_utilizador'].'" class="fa fa-wrench green_color"> Editar</a></td>
            </tr>';
                                }
                                $resultado->free();
                                $link->close();
