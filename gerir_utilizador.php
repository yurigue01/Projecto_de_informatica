                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="inserir_utilizador_adm.php" style="background-color: #229bc6; color: #fff;" class="btn account-btn  fa fa-plus blue2_color"  ">Inserir</a></th>
                            ...
                            <?php
                            require ("config.php");
                            $utilizador="SELECT utilizador.*, tipo_utilizador.* FROM utilizador  inner join tipo_utilizador on utilizador.Tipo_utilizador_ID_tipo = tipo_utilizador.ID_tipo ";
