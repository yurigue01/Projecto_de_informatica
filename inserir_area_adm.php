        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Gerir Area</h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="add_area_adm.php" style="background-color: #229bc6; color: #fff;" class="btn account-btn  fa fa-plus blue2_color"  ">Inserir</a></th>
            ...
            <td><a href="eliminar_area_adm.php?idArea='.$row['idArea'].'"  class="  fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="editar_area_adm.php?id='.$row['idArea'].'" class="fa fa-wrench green_color"> Editar</a></td>
